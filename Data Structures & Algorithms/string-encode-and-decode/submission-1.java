...
/*
encode:
initiate a res string
for each word in the list we want to get the length of the word:
concatenate the length, thsymbol #(indicating the start of a new word), and the word. to the res string
